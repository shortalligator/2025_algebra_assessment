...
class Levels:
    ...
    def __init__(self):
        ...
        intro_string = (
            ...
            "If the answer has decimals, round it to 2\ndecimal places, use a calculator if necessary"
        )
...
class EasyLevel:
    ...
    def __init__(self, how_many, partner):
        ...
        self.easy_box.protocol('WM_DELETE_WINDOW',
                                partial(self.close_easy, partner))
        ...
        buttons_list = [
            ...
            [self.buttons_frame, "END GAME", "#e31010", self.close_easy, 22, 3, None]
        ]
    ...
    def close_easy(self, placeholder):
        root.deiconify()
